...
>(({ className, ...props }, ref) => (
  <ScrollArea
    className={merge('grow overflow-auto rounded-2xl border', className)}
  >
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={merge(
      'h-12 px-6 py-3 text-right align-middle font-medium text-muted-foreground',
      className
    )}
    {...props}
  />
...
>(({ className, style, ...props }, ref) => (
  <td
    ref={ref}
    className={merge('px-6 py-3 align-middle text-right', className)}
